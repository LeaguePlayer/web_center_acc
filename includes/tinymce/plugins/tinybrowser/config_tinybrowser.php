...
$tinybrowser['path']['image'] = '/uploadfiles/pages/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/uploadfiles/pages/'; // Media files location
$tinybrowser['path']['file']  = '/uploadfiles/pages/'; // Other files location
