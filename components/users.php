<?php
	...
	function usersUser( $db = 0, $page = '', $item = 0 ) {
		...
		if( $flag ) {
            ...
            echo "<div class='userActions'><a class='userButton animationButton' href='#'><span data-text1='Вступление в Строительное СРО' data-text2='Быстро' data-text3='Надежно' data-text4='Рассрочка'>Вступление в Строительное СРО</span></a></div>";
        }
