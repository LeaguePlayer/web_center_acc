	...
	function pagesUser( $db = 0, $page = '' ) {
		...
		foreach( $result as $data ) {
			if ($data['alias'] == 'cooperation')
				echo "<h1 class='heading'>Добровольная сертификация  судебных экспертов</h1><br />";
			else
